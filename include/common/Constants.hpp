...
namespace Constants {
    ...
    inline constexpr float MIN_RANDOM_POS = -50.f;
    inline constexpr float MAX_RANDOM_POS =  50.f;

    inline constexpr float MIN_RANDOM_VEL = -6.f;
    inline constexpr float MAX_RANDOM_VEL =  6.f;
